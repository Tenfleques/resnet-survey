...
parser.add_argument('-d', '--depth', default=20, type=int, metavar='N', help='depth size of the network')
parser.add_argument('-rb', '--residual-block', default=-1, type=int, metavar='N', help='residual blocks configuration')
parser.add_argument('-sc', '--skip-connections', default=-1, type=int, metavar='N', help='skip connections configuration')
parser.add_argument('-tds', '--train-data-size', default=1.0, type=float, metavar='N', help='train data size')
...
def main():
    ...
    if use_gpu:
        ...
        if args.depth:
            print('model depth {}...'.format(args.depth))
        ...
        if not os.path.exists('result'):
            os.makedirs('result')
        fdir = 'result/resnet-{}_cifar10'.format(args.depth)
